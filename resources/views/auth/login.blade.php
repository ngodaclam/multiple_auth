    ...
    <div class="auth-wrapper auth-cover">
        <div class="auth-inner row m-0">
            ...
            <a class="brand-logo" href="home">
                ...
                <h2 class="brand-text text-primary ms-1">Jiian</h2>
            </a>
            <!-- /Brand logo-->
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title fw-bold mb-1">Welcome to jiian! 👋</h2>
                    <p class="card-text mb-2">Please login to your account and start managing partner</p>
                    @if (session('status'))
                        <ul>
                            <li class="text-danger"> {{ session('status') }}</li>
                        </ul>
                    @endif
                    <form class="auth-login-form mt-2" id="partner_login" method="POST" action="{{ route('login') }}">
                        @csrf
                        <input type="hidden" name="type" value="2">
                        <div class="mb-1">
                            <label class="form-label" for="login-phone">{{ __('Email') }}</label>
                            <input class="form-control" id="email" type="tel" name="email"
                                   placeholder="Enter your email" aria-describedby="email" autofocus=""
                                   tabindex="1"/>
                            <div class="error-text mb-2 mt-1"></div>
                        </div>
                        <div class="mb-1">
        ...
        $(document).ready(function () {
            ...
            $('#partner_login').validate({
                ...
                messages: {
                    ...
                    password: {
                        required: "Yêu Cầu Bắt Buộc ",
                        minlength: "Mật khẩu phải có ít nhất 6 kí t"
                    }
                },
