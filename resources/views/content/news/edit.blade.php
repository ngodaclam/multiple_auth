...
@section('content')
    <form class="add-new-record modal-content pt-0" id="edit-news-form" method="POST"
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text"
                                           value="{{old('image',$new->image)}}" name="image">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <select class="form-select select2" id="select-country" name="cate_id">
                                    @isset($categoryNews)
                                        @foreach($categoryNews as $c => $item)
                                            <option
                                                @if(old('cate_id') == $item->id || $item->id == $new->cate_id) selected
